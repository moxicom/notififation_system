...
class Config:
    SERVER_PORT: int = int(os.getenv("CALLBACK_PORT", default=8082))
    ...
    INPUT_QUEUE: str = os.getenv("CALLBACK_SERV_QUEUE", default="callback_input")

    MAIL_SENDER_URL: str = os.getenv("MAIL_SENDER_URL", default="http://localhost:8081/default")
    SMS_SENDER_URL: str = os.getenv("MAIL_SENDER_URL", default="http://localhost:8081/default")
